...
class UserProfileManager(models.Manager):
    use_for_related_fields = True #tell Django it must use this manager for any relationship lookups
...
class UserProfile(models.Model):
    ...
    #user.profile.following --user i following
...
#Samuel = User.objects.first()
#User.object.get_or_create() #(user.obj, true/false)
#Samuel.save()
