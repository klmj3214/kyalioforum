...
urlpatterns = [
    ...
    url(r'^api/tweet/',include(('tweets.api.urls','tweets.api'),namespace = 'tweet-api')),
    url(r'^api/',include(('accounts.api.urls','tweets'),namespace = 'profiles-api')),
    url(r'^register/$', UserRegisterView.as_view(), name = 'register'),#/
    url(r'^', include('django.contrib.auth.urls')),
    url(r'^',include(('accounts.urls','tweets'),namespace = 'profiles')),
]
